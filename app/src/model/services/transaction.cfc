component output="false" accessors="true" {
	...
	public array function searchTransactions(required struct searchParams, string returnType = 'objects') {
		...
		if (keyIsSet(arguments.searchParams, 'amountType') && keyIsSet(arguments.searchparams, 'amount')) {
			var typeMap = {
				"eq": "=",
				"gt": ">",
				"lt": "<"
			};
			conditions &= " and abs(t.amount) #typeMap[arguments.searchParams.amountType]# :amount";
			parameters['amount'] = listToArray(arguments.searchParams.amount);
		}
